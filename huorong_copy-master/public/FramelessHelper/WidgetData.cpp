...
void WidgetData::updateCursorShape(const QPoint &gMousePos)
{
    ...
    //qDebug() << __FUNCTION__ << __LINE__ << m_moveMousePos.m_bOnLeftEdge << d->m_bWidgetResizable << m_moveMousePos.m_bOnTopLeftEdge << m_moveMousePos.m_bOnBottomRightEdge;
...
{
	if (event->button() == Qt::LeftButton && !m_pWidget->isMaximized())
    {
