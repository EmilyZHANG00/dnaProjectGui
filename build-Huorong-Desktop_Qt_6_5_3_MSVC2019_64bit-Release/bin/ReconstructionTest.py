...
imagePath = 'D:\Desktop\Dna-encoding\test\test1.jpg'  # 替换为你的图片路径
videoPath = 'D:\Desktop\Dna-encoding\test\test160p.mp4'
...
def all_test():
    textTest_Reconstruction(originText,1)     # 不加分隔符
    textTest_Reconstruction(originText,2)      # 加人工碱基作为分隔符，全空间
    textTest_Reconstruction(originText,3)      # 人工碱基 + VT码
...
# D:\Desktop\Dna-encoding\data\Image5.jpg
